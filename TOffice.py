...
# 파일 내 이미지 한번에 저장하기 (결과 저장 폴더, 작업 대상 폴더) - Ch2.6
...
# 같은 양식의 엑셀 파일 취합 (결과 저장 폴더, 작업 대상 폴더) - Ch3.5
...
# 유사한 양식의 엑셀 파일 취합 (결과 저장 폴더, 작업 대상 폴더, 양식파일) - Ch3.5
def M_xl(TPath, RPath, Format):
    ...
    # 폴더 경로 설정하기 (TPath : Target Data가 모여 있는 폴더, 
    #                   RPath : Result를 저장할 폴더 )
    # TPath = r'C:\Data\Sample\3_5_Merge_Excel2\Data'
    # RPath = r'C:\Data\Sample\3_5_Merge_Excel2\Result'
...
# 파워포인트 폰트 한번에 통일 (결과 저장폴더, 작업 대상 폴더, 영문폰트, 한글폰트) - Ch4.2
...
# PPT 단어 일괄 수정 (결과 저장 폴더, 작업 대상 폴더, 양식파일) - Ch4.3
def PPT_Dic(TPath, RPath, DPath):
    # 읽어올 파일 경로 및 폴더 경로 지정 TPath : 타겟 파일 경로, RPath : 결과 파일경로, 
    #                                 DPath : 사전 파일 경로
    # TPath = r'C:\Data\Sample\4_3_Change_Words_PPT\Data'
    # RPath = r'C:\Data\Sample\4_3_Change_Words_PPT\Result'
    # DPath = r'C:\Data\Sample\4_3_Change_Words_PPT\Dictionary.xlsx'
...
# 워드 단어 일괄 수정 (결과 저장 폴더, 작업 대상 폴더, 양식파일) - Ch4.4
...
# 폴더내 문서 PDF 파일 저장 (결과 저장 폴더, 작업 대상 폴더) - Ch5.4
...
# 폴더내 이미지 모아 PDF 파일 저장 (결과 저장 폴더, 작업 대상 폴더) - Ch5.5
...
# 폴더내 PDF 파일 암호 설정 (결과 저장 폴더, 작업 대상 폴더, 암호) - Ch5.6
